  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="flex gap-4 mb-6">
        <button
          className={`px-4 py-2 rounded ${mode === "basic" ? "bg-blue-600 text-white" : "bg-gray-200"}`}
          onClick={() => setMode("basic")}
        >
          Create Permission Only
        </button>
        <button
          className={`px-4 py-2 rounded ${mode === "withGroup" ? "bg-blue-600 text-white" : "bg-gray-200"}`}
